...
#ifndef C_CLEO_REG_HEANDLE_FROM_POOL_H
#define C_CLEO_REG_HEANDLE_FROM_POOL_H


class TEST_SPAWN_AND_REG_CAR_DATABASE : public CLEO_machine
{
public:
	TEST_SPAWN_AND_REG_CAR_DATABASE( float A1, float A2, float A3, float A4
		, float A5, float A6, float A7, float A8, float A9, float A10);
		//: CLEO_machine(A1, A2, A3, A4, A5, A6, A7, A8, A9, A10);

	TEST_SPAWN_AND_REG_CAR_DATABASE();
	  
	void regCarbyheandle();
};
...
#if 0
// #ifndef C_CLEO_REQUET_GET_HEANDLE_OF_PO0L_H
// #define C_CLEO_REQUET_GET_HEANDLE_OF_PO0L_H

class TEST_CLEO_REQUET_GET_HEANDLE_OF_PO0L: public CLEO_machine
{
public:
	void Get_Heandle_of_Pool();

	void START_Thr_Get_Heandle_of_Pool();
};
